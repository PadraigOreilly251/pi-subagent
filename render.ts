/**
 * TUI rendering for subagent tool calls and results (Phase 1).
 *
 * Single sub-agent only. No parallel execution. No delegation mode display.
 */
